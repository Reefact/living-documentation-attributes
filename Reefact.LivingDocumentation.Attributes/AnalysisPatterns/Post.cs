...
namespace Reefact.LivingDocumentation.Attributes.AnalysisPatterns {
    ...
    ///     </para>
    ///     <para>
    ///         A narrower case of Party, in Analysis Patterns: every participant annotated here is one of those too,
    ///         and a consumer asking for the broader pattern gets these as well.
    ///     </para>
    ///     <para>
    ...
    public sealed class PostAttribute : AnalysisPatterns.PartyAttribute { }

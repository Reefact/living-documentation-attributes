...
namespace Reefact.LivingDocumentation.Attributes.AnalysisPatterns {
    ...
    ///     </para>
    ///     <para>
    ///         A narrower case of Protocol, in Analysis Patterns: every participant annotated here is one of those too,
    ...
    public static class MeasurementProtocol {
        ...
        /// </summary>
        public abstract class Role : AnalysisPatterns.ProtocolAttribute { }

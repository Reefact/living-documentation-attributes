...
| `Posa2` | 4 | in progress | Schmidt, Stal, Rohnert & Buschmann — *Pattern-Oriented Software Architecture, Volume 2*, 2000 |
| `Idioms` | 2 | open-ended | patterns with a source but no catalog of their own — each entry names its own |

**319 patterns, 554 roles** today, and the catalog is meant to grow by an order of

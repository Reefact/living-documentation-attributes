...
| `EnterpriseIntegration` | 45 | Hohpe & Woolf — *Enterprise Integration Patterns*, 2003 |
| `Idioms` | 2 | patterns with a source but no catalog of their own — each entry names its own |

**192 patterns, 385 roles** today, and the catalog is meant to grow by an order of
...
[ADR base](doc/handwritten/for-maintainers/adr/) — 29 records, English

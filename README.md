...
| `EnterpriseApplicationArchitecture` | 37 | Fowler — *Patterns of Enterprise Application Architecture*, 2002 |
| `Idioms` | 2 | patterns with a source but no catalog of their own — each entry names its own |

**81 patterns, 147 roles** today, and the catalog is meant to grow by an order of

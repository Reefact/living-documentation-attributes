...
| `MicroservicesPatterns` | 25 | in progress | Richardson — *Microservices Patterns*, 2018 |
| `Idioms` | 2 | open-ended | patterns with a source but no catalog of their own — each entry names its own |

**299 patterns, 526 roles** today, and the catalog is meant to grow by an order of

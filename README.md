...
| `MicroservicesPatterns` | 34 | in progress | Richardson — *Microservices Patterns*, 2018 |
| `Idioms` | 2 | open-ended | patterns with a source but no catalog of their own — each entry names its own |

**308 patterns, 535 roles** today, and the catalog is meant to grow by an order of

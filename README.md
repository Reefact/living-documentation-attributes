...
| `AnalysisPatterns` | 37 | Fowler — *Analysis Patterns*, 1997 |
...
**145 patterns, 305 roles** today, and the catalog is meant to grow by an order of
...
[ADR base](doc/handwritten/for-maintainers/adr/) — 28 records, English

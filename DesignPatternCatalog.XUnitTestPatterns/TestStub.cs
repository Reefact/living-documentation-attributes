...
namespace DesignPatternCatalog.XUnitTestPatterns {
    ...
    /// <summary>
    ///     TestStub (xUnit Test Patterns) — Feeds the system under test the indirect inputs a test needs, so that logic
    ///     depending on what another component returns can be verified.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    public sealed class TestStubAttribute : TestDoubleAttribute { }

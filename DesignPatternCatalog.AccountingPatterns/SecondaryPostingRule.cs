...
namespace DesignPatternCatalog.AccountingPatterns {
    ...
    ///     </para>
    ///     <para>
    ///         A narrower case of PostingRule: every participant annotated here is one of those too, and a consumer
    ...
    public sealed class SecondaryPostingRuleAttribute : PostingRule.Role { }

...
<!-- An ADR records a DECISION and its REASONING, not how it is implemented.
     ...
     specification: it lives in the code and the reference docs (the catalog, the
     generator, the reference docs), which this ADR links to. Test: if the implementation

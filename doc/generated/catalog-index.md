...
**70 patterns, 136 roles**, across 4 catalogs. A pattern is catalogued in the body of work that named it, under the name that work gave it — so a reader of a book finds its patterns spelled as it spelled them, and two works that name one pattern are related rather than merged.
...
`Reefact.LivingDocumentation.Attributes.EnterpriseApplicationArchitecture` — 26 patterns, 26 roles.
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ActiveRecord | `[ActiveRecord]` | class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| DataMapper | `[DataMapper]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| DataTransferObject | `[DataTransferObject]` | class, struct | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| DomainModel | `[DomainModel]` | assembly | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Gateway | `[Gateway]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| IdentityMap | `[IdentityMap]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| LayerSupertype | `[LayerSupertype]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| LazyLoad | `[LazyLoad]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Mapper | `[Mapper]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| QueryObject | `[QueryObject]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| RecordSet | `[RecordSet]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Registry | `[Registry]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| RemoteFacade | `[RemoteFacade]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| RowDataGateway | `[RowDataGateway]` | class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| SeparatedInterface | `[SeparatedInterface]` | interface | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServiceLayer | `[ServiceLayer]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServiceStub | `[ServiceStub]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| SpecialCase | `[SpecialCase]` | class, struct | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| TableDataGateway | `[TableDataGateway]` | interface, class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| TableModule | `[TableModule]` | class | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| NullObject | `[NullObject]` | class, struct | yes | — |
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ObjectMother | `[ObjectMother]` | class | yes | — |

...
**184 patterns, 370 roles**, across 7 catalogs. A pattern is catalogued in the body of work that named it, under the name that work gave it — so a reader of a book finds its patterns spelled as it spelled them, and two works that name one pattern are related rather than merged.
...
`Reefact.LivingDocumentation.Attributes.EnterpriseIntegration` — 37 patterns, 54 roles.

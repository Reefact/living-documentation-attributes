...
**216 patterns, 418 roles**, across 8 catalogs. A pattern is catalogued in the body of work that named it, under the name that work gave it — so a reader of a book finds its patterns spelled as it spelled them, and two works that name one pattern are related rather than merged.
...
`Reefact.LivingDocumentation.Attributes.XUnitTestPatterns` — 4 patterns, 4 roles.

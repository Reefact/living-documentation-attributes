...
**343 patterns, 619 roles**, across 11 catalogs. A pattern is catalogued in the body of work that named it, under the name that work gave it — so a reader of a book finds its patterns spelled as it spelled them, and two works that name one pattern are related rather than merged.
...
| [AcceptorConnector](#acceptorconnector-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 4 | — |
| [AccessToken](#accesstoken-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [ActiveObject](#activeobject-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 6 | — |
...
| [AmbientContext](#ambientcontext-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
| [AntiCorruptionLayer](#anticorruptionlayer-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [ApiGateway](#apigateway-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [ApplicationMetrics](#applicationmetrics-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [AsynchronousCompletionToken](#asynchronouscompletiontoken-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 3 | — |
| [AuditLogging](#auditlogging-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [BackendForFrontend](#backendforfrontend-microservices-patterns) | Microservices Patterns | 1 | narrows ApiGateway |
...
| [CircuitBreaker](#circuitbreaker-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [ClientSideServiceDiscovery](#clientsideservicediscovery-microservices-patterns) | Microservices Patterns | 1 | — |
| [ClientSideUiComposition](#clientsideuicomposition-microservices-patterns) | Microservices Patterns | 2 | — |
...
| [ComponentConfigurator](#componentconfigurator-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 4 | — |
...
| [CompositionRoot](#compositionroot-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
...
| [ConstrainedConstruction](#constrainedconstruction-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
| [ConstructorInjection](#constructorinjection-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
...
| [ControlFreak](#controlfreak-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
...
| [DecomposeByBusinessCapability](#decomposebybusinesscapability-microservices-patterns) | Microservices Patterns | 1 | — |
| [DecomposeBySubdomain](#decomposebysubdomain-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [DistributedTracing](#distributedtracing-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [DomainSpecificProtocol](#domainspecificprotocol-microservices-patterns) | Microservices Patterns | 1 | — |
| [DoubleCheckedLockingOptimization](#doublecheckedlockingoptimization-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 3 | — |
...
| [ExceptionTracking](#exceptiontracking-microservices-patterns) | Microservices Patterns | 1 | — |
| [ExtensionInterface](#extensioninterface-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 4 | — |
| [ExternalizedConfiguration](#externalizedconfiguration-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [HalfSyncHalfAsync](#halfsynchalfasync-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 3 | — |
| [HardCodedTestDouble](#hardcodedtestdouble-xunit-test-patterns) | xUnit Test Patterns | 1 | narrows TestDouble |
| [HealthCheckApi](#healthcheckapi-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [IdempotentConsumer](#idempotentconsumer-microservices-patterns) | Microservices Patterns | 2 | — |
...
| [Interceptor](#interceptor-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 5 | — |
...
| [LeaderFollowers](#leaderfollowers-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 4 | — |
...
| [Messaging](#messaging-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [MethodInjection](#methodinjection-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
| [MicroserviceChassis](#microservicechassis-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [MonitorObject](#monitorobject-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 4 | — |
...
| [Proactor](#proactor-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 5 | — |
...
| [PropertyInjection](#propertyinjection-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
...
| [Reactor](#reactor-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 5 | — |
...
| [RemoteProcedureInvocation](#remoteprocedureinvocation-microservices-patterns) | Microservices Patterns | 2 | — |
...
| [ScopedLifestyle](#scopedlifestyle-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
| [ScopedLocking](#scopedlocking-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 2 | — |
...
| [SelfContainedService](#selfcontainedservice-microservices-patterns) | Microservices Patterns | 1 | — |
| [SelfRegistration](#selfregistration-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [ServerSidePageFragmentComposition](#serversidepagefragmentcomposition-microservices-patterns) | Microservices Patterns | 2 | — |
| [ServerSideServiceDiscovery](#serversideservicediscovery-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [ServiceComponentTest](#servicecomponenttest-microservices-patterns) | Microservices Patterns | 2 | — |
| [ServiceIntegrationContractTest](#serviceintegrationcontracttest-microservices-patterns) | Microservices Patterns | 3 | — |
...
| [ServiceLocator](#servicelocator-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 2 | — |
| [ServicePerTeam](#serviceperteam-microservices-patterns) | Microservices Patterns | 1 | — |
| [ServiceRegistry](#serviceregistry-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [ServiceTemplate](#servicetemplate-microservices-patterns) | Microservices Patterns | 1 | — |
...
| [SingletonLifestyle](#singletonlifestyle-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
...
| [StranglerApplication](#stranglerapplication-microservices-patterns) | Microservices Patterns | 4 | — |
| [StrategizedLocking](#strategizedlocking-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 2 | — |
...
| [ThreadSafeInterface](#threadsafeinterface-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 3 | — |
| [ThreadSpecificStorage](#threadspecificstorage-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 4 | — |
...
| [TransientLifestyle](#transientlifestyle-dependency-injection-principles-practices-and-patterns) | Dependency Injection Principles, Practices, and Patterns | 1 | — |
...
| [WrapperFacade](#wrapperfacade-pattern-oriented-software-architecture-volume-2) | Pattern-Oriented Software Architecture, Volume 2 | 2 | — |
...
Exposes a dependency through a static access point that any code may reach, so that it is passed to nobody and available to everybody.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| AmbientContext | `[AmbientContext]` | class, property, field | no | — |
...
Assembles the application's object graph in one location as close as possible to its entry point, so that everything else is composed rather than composing.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| CompositionRoot | `[CompositionRoot]` | class, method | no | — |
...
Requires every implementation of an abstraction to offer a particular constructor signature, so that something outside can create them all the same way.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ConstrainedConstruction | `[ConstrainedConstruction]` | constructor | no | — |
...
Declares the dependencies a class requires by taking them as constructor parameters, so that an instance cannot exist without them.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ConstructorInjection | `[ConstructorInjection]` | constructor | no | — |
...
A class that creates the dependencies it uses, so that nothing outside it can choose them.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ControlFreak | `[ControlFreak]` | class, struct | no | — |
...
Supplies a dependency as a parameter of the method that uses it, so that it may differ from one call to the next.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| MethodInjection | `[MethodInjection]` | method | no | — |
...
Exposes a settable property through which an optional dependency may be supplied, the class remaining usable when it is not.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| PropertyInjection | `[PropertyInjection]` | property | no | — |
...
One instance serves a well-defined scope — a web request, a unit of work — and a different one serves the next.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ScopedLifestyle | `[ScopedLifestyle]` | class, struct | no | — |
...
Supplies a dependency by having the consumer ask a registry for it at the moment it is needed, rather than being given it.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServiceLocator | `[ServiceLocator.ServiceLocator]` | interface, class | no | — |
| Consumer | `[ServiceLocator.Consumer]` | class, struct | no | `ServiceLocator` |

**ServiceLocator** — The registry a consumer asks. It is not the participant that carries the cost, and a codebase has one of these against many consumers — annotating it says where the boundary of the pattern is, so a rule can range over everything that touches it.
...
One instance serves every consumer for the lifetime of the application, created once and never replaced.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| SingletonLifestyle | `[SingletonLifestyle]` | class, struct | no | — |
...
A new instance is created for every consumer that asks for one, and none is ever reused.

*Steven van Deursen, Mark Seemann, Dependency Injection Principles, Practices, and Patterns, 2019.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| TransientLifestyle | `[TransientLifestyle]` | class, struct | no | — |
...
Has the API gateway authenticate a request and pass a token that identifies the requestor onward, so that every service downstream knows who is asking without asking again.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| AccessToken | `[AccessToken]` | interface, class, struct | no | — |
...
Translates between a legacy monolith's domain model and a new service's, so that the model being escaped does not reach the model being built.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| AntiCorruptionLayer | `[AntiCorruptionLayer]` | interface, class, assembly | yes | — |
...
Gives every client one entry point, routing some requests to a single service and answering others by fanning out to several, so that no client has to know how the application is partitioned.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ApiGateway | `[ApiGateway]` | interface, class, assembly | no | — |
...
Instruments a service so that each operation reports statistics to a metrics service, by push or by pull, and behaviour can be seen rather than guessed at.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ApplicationMetrics | `[ApplicationMetrics]` | interface, class, method | no | — |
...
Records what users did, in a database, so that the question of who changed what has an answer.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| AuditLogging | `[AuditLogging]` | interface, class, method | no | — |
...
Gives each kind of client an API gateway of its own, so that the API a mobile application is served is designed for a mobile application and changes with it.

*Chris Richardson, Microservices Patterns, 2018.*

A narrower case of **ApiGateway**: every participant here is one of those too.

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| BackendForFrontend | `[BackendForFrontend]` | interface, class, assembly | no | — |
...
Invokes a remote service through a proxy that counts failures and, past a threshold, fails immediately for a time rather than letting a slow or dead service exhaust the caller's threads.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| CircuitBreaker | `[CircuitBreaker]` | interface, class, method | no | — |
...
Has the caller ask a service registry where the instances of a service are, and choose one itself, rather than being handed a fixed address.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ClientSideServiceDiscovery | `[ClientSideServiceDiscovery]` | interface, class | no | — |
...
Builds one screen from UI components rendered by several service-specific front ends, composed on the client.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| UiComponent | `[ClientSideUiComposition.UiComponent]` | interface, class | yes | `PageSkeleton` |
| PageSkeleton | `[ClientSideUiComposition.PageSkeleton]` | interface, class | yes | — |

**UiComponent** — The participant rendering one region, owned by the team behind its service. Composed in the browser rather than on the server, so a failure degrades one region instead of the response.
...
Draws a service around one business capability — something the business does in order to generate value — so that a change to that capability lands in one service and one team.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| DecomposeByBusinessCapability | `[DecomposeByBusinessCapability]` | interface, class, assembly | no | — |
...
Draws a service around one subdomain of the business as domain-driven design identifies them, so that the boundary follows the model rather than what the organisation happens to do.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| DecomposeBySubdomain | `[DecomposeBySubdomain]` | interface, class, assembly | no | — |
...
Gives each external request an identifier, passes it to every service that handles it, and records the timing of each step centrally, so that one slow request can be followed across services.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| DistributedTracing | `[DistributedTracing]` | interface, class, method | no | — |
...
Has services collaborate over a protocol belonging to their domain — mail, media streaming — rather than over a general-purpose request/reply or messaging one.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| DomainSpecificProtocol | `[DomainSpecificProtocol]` | interface, class, assembly | no | — |
...
Reports every exception to a service that de-duplicates, tracks and notifies, so that a fault is investigated rather than merely logged.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ExceptionTracking | `[ExceptionTracking]` | interface, class | no | — |
...
Keeps every environment-dependent value — credentials, endpoints, limits — outside the code and reads it on startup, so that one build runs everywhere.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ExternalizedConfiguration | `[ExternalizedConfiguration]` | interface, class | no | — |
...
Gives a service an endpoint that says whether this instance can handle requests, for a monitor, a registry or a load balancer to ask.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| HealthCheckApi | `[HealthCheckApi]` | interface, class, method | no | — |
...
Lets a consumer be invoked repeatedly with one message and produce the outcome it would have produced once, by recording the messages it has already handled.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| IdempotentConsumer | `[IdempotentConsumer.IdempotentConsumer]` | interface, class, method | no | `ProcessedMessages` |
| ProcessedMessages | `[IdempotentConsumer.ProcessedMessages]` | interface, class | no | — |

**IdempotentConsumer** — The handler for which processing a message once and processing it three times have the same outcome. At-least-once delivery makes that obligatory rather than desirable, and nothing but this says which handlers have honoured it.
...
Has services collaborate by exchanging messages over channels rather than by calling one another, so that neither has to be running when the other is.
...
Gathers the cross-cutting concerns every service needs — configuration, logging, health checks, metrics, discovery — into a framework, so that a new service starts from them rather than reimplementing them.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| MicroserviceChassis | `[MicroserviceChassis]` | interface, class, assembly | no | — |
...
Publishes the messages an outbox holds by polling the table for them, which works on any database and buys that with a poll interval and an ordering problem.
...
Has services collaborate by request and reply over a network protocol, so that a caller gets its answer at once and is unavailable for as long as the service it called is.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Service | `[RemoteProcedureInvocation.Service]` | interface, class, assembly | no | — |
| Client | `[RemoteProcedureInvocation.Client]` | interface, class, assembly | yes | `Service` |

**Service** — The participant that exposes a request/reply API to other services. Its availability becomes theirs for the duration of every call, and its signature says nothing about that.
...
Designs a service so that it answers a synchronous request without waiting on any other service, keeping a replica of what it needs to read and finishing the rest asynchronously.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| SelfContainedService | `[SelfContainedService]` | interface, class, assembly | no | — |
...
Has each service instance register itself with the registry on startup, renew while it lives and unregister on shutdown.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| SelfRegistration | `[SelfRegistration]` | interface, class, assembly | no | — |
...
Builds one page from HTML fragments generated by several service-specific web applications, aggregated on the server.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Fragment | `[ServerSidePageFragmentComposition.Fragment]` | interface, class | yes | `PageTemplate` |
| PageTemplate | `[ServerSidePageFragmentComposition.PageTemplate]` | interface, class | yes | — |

**Fragment** — The participant generating one region of the page, owned by the team that owns the service behind it. Its release cadence is its own, which is the point — and the page it lands in is somebody else's.
...
Has the caller send its request to a router at a well known address, and the router ask the registry which instance should receive it.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServerSideServiceDiscovery | `[ServerSideServiceDiscovery]` | interface, class, assembly | no | — |
...
Tests one service on its own, standing in for every service it invokes, so that the suite is fast and reliable and its verdict rests entirely on how honest the stand-ins are.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServiceComponentTest | `[ServiceComponentTest.ServiceComponentTest]` | class, method | no | `ServiceUnderTest` |
| ServiceUnderTest | `[ServiceComponentTest.ServiceUnderTest]` | interface, class, assembly | yes | — |

**ServiceComponentTest** — The suite that exercises the service and nothing beyond it. Fast, cheap and reliable, and it can be entirely green while the application is broken — which is the trade the work states rather than a defect in any particular suite.
...
Has the developers of a consuming service write the suite that verifies the provider's API, so that the provider finds out it has broken somebody in its own build rather than in production.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServiceIntegrationContractTest | `[ServiceIntegrationContractTest.ServiceIntegrationContractTest]` | class, method | no | `Provider`, `Consumer` |
| Provider | `[ServiceIntegrationContractTest.Provider]` | interface, class, assembly | yes | — |
| Consumer | `[ServiceIntegrationContractTest.Consumer]` | interface, class, assembly | yes | — |

**ServiceIntegrationContractTest** — The suite, written by one team and run by another. That split is the whole pattern and the thing a test class does not show: it fails for people who did not write it, who cannot tell from reading it whether the expectation still holds.

**Provider** — The service whose API is under test. Green says it still meets the expectations of the consumers who wrote a suite, and says nothing whatever about the consumers who did not.
...
Gives each team sole responsibility for changing its own service, and ideally one service, so that autonomy is achieved with the fewest services rather than the most.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServicePerTeam | `[ServicePerTeam]` | interface, class, assembly | no | — |
...
Holds where every instance of every service is, written on startup and erased on shutdown, so that callers and routers have somewhere to ask.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServiceRegistry | `[ServiceRegistry]` | interface, class | no | — |
...
A runnable skeleton service, complete with the build and the cross-cutting concerns, meant to be copied so that a new service starts consistent rather than improvised.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServiceTemplate | `[ServiceTemplate]` | class, assembly | no | — |
...
Migrates a monolith by growing a new application around it, service by service, so that the monolith's share of the work only ever shrinks and no rewrite has to be finished before anything ships.

*Chris Richardson, Microservices Patterns, 2018.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| StranglerApplication | `[StranglerApplication.StranglerApplication]` | interface, class, assembly | no | — |
| Monolith | `[StranglerApplication.Monolith]` | interface, class, assembly | no | — |
| ExtractedService | `[StranglerApplication.ExtractedService]` | interface, class, assembly | no | `Monolith` |
| NewService | `[StranglerApplication.NewService]` | interface, class, assembly | no | `StranglerApplication` |

**StranglerApplication** — The new application growing around the old one. Its value is that it ships before the migration is over, and its risk is that the migration is never over — which is a state nothing in the code reports.

**Monolith** — The legacy application being strangled. Saying so is what distinguishes it from an application nobody intends to replace, and the two are otherwise identical to read.

**ExtractedService** — A service holding functionality that used to live in the monolith. It carries an obligation the new code cannot show: there is, or was, code in the monolith doing this too, and until somebody deletes it the system has two answers to one question.
...
| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| TransactionLogTailing | `[TransactionLogTailing]` | interface, class | no | — |
...
Decouples connecting and initializing cooperating peer services in a networked system from the processing those services perform once connected.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ServiceHandler | `[AcceptorConnector.ServiceHandler]` | interface, class | no | — |
| Acceptor | `[AcceptorConnector.Acceptor]` | interface, class | no | `ServiceHandler` |
| Connector | `[AcceptorConnector.Connector]` | interface, class | no | `ServiceHandler` |
| TransportEndpoint | `[AcceptorConnector.TransportEndpoint]` | field, property | no | `ServiceHandler` |

**ServiceHandler** — Performs the application's work over an established connection, and offers the hook an acceptor or connector calls to activate it. Once running it does not talk to either of them again, which is what lets the same handler be reached passively or actively.

**Acceptor** — Passively waits at an address for connection requests, then creates and activates a service handler for each. It is a factory, so what it decides is not how a connection is used but which handler exists at all.

**Connector** — Actively initiates a connection to a remote acceptor and activates the service handler when it is established. It may finish synchronously or asynchronously, and the handler is written not to know which.
...
Decouples method invocation from method execution, so that a client's call returns at once and the work runs later in the object's own thread.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Proxy | `[ActiveObject.Proxy]` | interface, class | no | — |
| MethodRequest | `[ActiveObject.MethodRequest]` | interface, class | yes | `Proxy` |
| ActivationList | `[ActiveObject.ActivationList]` | interface, class | yes | `Proxy` |
| Scheduler | `[ActiveObject.Scheduler]` | interface, class | yes | `Proxy` |
| Servant | `[ActiveObject.Servant]` | interface, class | no | `Proxy` |
| Future | `[ActiveObject.Future]` | interface, class, struct | yes | `Proxy` |

**Proxy** — The interface clients call, in the client's own thread. Every call it takes returns immediately, having built a method request and queued it — so a caller who reasons about what has happened by the time the call returns is reasoning about nothing.

**MethodRequest** — Carries the context of one invocation from the proxy to the scheduler: the arguments, the servant to apply them to, somewhere to put the result, and the code to run. It also carries the guard that says whether it may run yet.

**ActivationList** — Holds the method requests that are pending. It is bounded, which is the part that matters: it is what decouples the calling thread from the executing one, and what a client blocks on once the object is further behind than the list is long.

**Scheduler** — Runs in a thread of its own, decides which pending request may run next by evaluating its guard, and dispatches it on the servant. The order it chooses is the object's concurrency policy, and it is a decision rather than a queue discipline.

**Servant** — Defines the behaviour and state being modelled as an active object, and holds no synchronization at all — that is deliberate, and it is what lets the same servant be scheduled under a different policy without being rewritten.
...
Lets an application demultiplex the responses of the asynchronous operations it invoked, by handing the service a value it returns untouched with the completion.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| AsynchronousCompletionToken | `[AsynchronousCompletionToken.AsynchronousCompletionToken]` | interface, class, struct | yes | — |
| Client | `[AsynchronousCompletionToken.Client]` | interface, class | no | `AsynchronousCompletionToken` |
| Service | `[AsynchronousCompletionToken.Service]` | interface, class | no | `AsynchronousCompletionToken` |

**AsynchronousCompletionToken** — Identifies the actions and the state the client needs in order to process one completion. Opaque to the service and meaningful to the client, which is the whole trick: it travels through code that cannot interpret it and must not try.

**Client** — Invokes the operation, supplies the token with it, and is the only participant that can make sense of the token when it comes back. Everything it will need at completion time has to be reachable from that token, and what it forgot is not recoverable later.
...
Lets an application link and unlink its component implementations at run time, without modifying, recompiling or relinking the application.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Component | `[ComponentConfigurator.Component]` | interface, class | no | — |
| ConcreteComponent | `[ComponentConfigurator.ConcreteComponent]` | class | no | `Component` |
| ComponentRepository | `[ComponentConfigurator.ComponentRepository]` | interface, class | yes | `Component` |
| ComponentConfigurator | `[ComponentConfigurator.ComponentConfigurator]` | interface, class | yes | `Component` |

**Component** — Declares the hooks by which a component is initialized, suspended, resumed and terminated. Everything the configurator can do to a component is on this interface, so a component that needs anything else is one the configurator cannot manage.

**ConcreteComponent** — Implements the hooks and the service itself. Its initialization runs at a moment the application chooses rather than at start-up, so anything it assumes about what else exists yet is an assumption about configuration order.

**ComponentRepository** — Holds the components currently configured into the application, and is what makes them addressable at run time. A component missing from here is not merely unreachable — it cannot be suspended, resumed or terminated either.
...
Reduces contention where a critical section must run exactly once, by testing a flag before taking the lock and testing it again after taking it.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| JustOnceCriticalSection | `[DoubleCheckedLockingOptimization.JustOnceCriticalSection]` | method | no | — |
| Mutex | `[DoubleCheckedLockingOptimization.Mutex]` | field, property | yes | — |
| Flag | `[DoubleCheckedLockingOptimization.Flag]` | field, property | no | — |

**JustOnceCriticalSection** — The code that must execute exactly once, an initialisation typically. It is reached rarely compared with the accesses that find the work already done, which is the entire reason for paying for two tests instead of one lock.

**Mutex** — The lock that serializes the threads which find the flag unset. It is contended on the first pass and untouched afterwards, so a measurement taken once the flag is set will show this lock costing nothing and prove nothing.
...
Lets one component export several interfaces, so that extending it neither bloats a single interface nor breaks the code of clients that do not want the extension.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Component | `[ExtensionInterface.Component]` | class | no | — |
| RootInterface | `[ExtensionInterface.RootInterface]` | interface | no | `Component` |
| ExtensionInterface | `[ExtensionInterface.ExtensionInterface]` | interface | yes | `RootInterface` |
| ComponentFactory | `[ExtensionInterface.ComponentFactory]` | interface, class | yes | `Component` |

**Component** — Implements the interfaces, and is reached only through them. A client never holds this type, which is what lets the set of interfaces grow without any client being recompiled.

**RootInterface** — The interface every extension extends, and the one that answers the question *do you also do this?* A client's whole ability to discover what a component can do is this one operation.

**ExtensionInterface** — One coherent set of operations a component may export, extending the root. Adding another breaks nothing, which is the pattern's claim — and the cost is that a client cannot tell from the type system whether a component supports it, only by asking at run time.
...
Decomposes concurrent processing into a synchronous layer and an asynchronous one, with a queueing layer between them, so simplicity and responsiveness are each paid for where they are worth it.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| SynchronousTaskLayer | `[HalfSyncHalfAsync.SynchronousTaskLayer]` | interface, class, assembly | no | `QueueingLayer` |
| AsynchronousTaskLayer | `[HalfSyncHalfAsync.AsynchronousTaskLayer]` | interface, class, assembly | no | `QueueingLayer` |
| QueueingLayer | `[HalfSyncHalfAsync.QueueingLayer]` | interface, class | yes | — |

**SynchronousTaskLayer** — Where the high-level work happens, in threads of its own that may block: it has a stack and registers, so it can be written as a sequence of steps and read as one. Everything easy to follow in the system lives here, and it is here that the thread count is paid for.

**AsynchronousTaskLayer** — Where the low-level work happens, driven by events from outside and never blocking, because it has no stack of its own to block on. A blocking call added here does not slow the layer down — it stops the system taking events at all.
...
Lets services be added to a framework transparently, and triggered automatically when particular events occur.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Interceptor | `[Interceptor.Interceptor]` | interface, class | no | — |
| ConcreteInterceptor | `[Interceptor.ConcreteInterceptor]` | class | no | `Interceptor` |
| Dispatcher | `[Interceptor.Dispatcher]` | interface, class | yes | `Interceptor` |
| Context | `[Interceptor.Context]` | interface, class, struct | yes | `Interceptor` |
| Framework | `[Interceptor.Framework]` | interface, class, assembly | no | `Interceptor` |

**Interceptor** — Declares the event-handling hook the framework calls out through. Its implementations are not called by the application at all, which is what makes their effects hard to trace from a stack trace and worth annotating.

**ConcreteInterceptor** — Implements the hook for the events it has subscribed to. It runs on the framework's path rather than the application's, so the cost of what it does is paid by every request the framework handles and attributed to none of them.

**Dispatcher** — Registers and removes interceptors and delegates events to them. Its registration order is the order the interceptors run in, and that order is a decision nothing else records.

**Context** — Carries the information about the event that the interceptor may read, and through which it may change what the framework does next. It is the whole of the interceptor's authority, so what it exposes is what the framework has agreed to let an outsider decide.
...
Lets a pool of threads take turns waiting on a shared set of event sources, so that the thread which receives an event is the thread that processes it, with no handoff and no dedicated dispatcher.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ThreadPool | `[LeaderFollowers.ThreadPool]` | interface, class | no | — |
| HandleSet | `[LeaderFollowers.HandleSet]` | interface, class | yes | `ThreadPool` |
| EventHandler | `[LeaderFollowers.EventHandler]` | interface, class | no | `ThreadPool` |
| ConcreteEventHandler | `[LeaderFollowers.ConcreteEventHandler]` | class, struct | no | `EventHandler` |

**ThreadPool** — The group of threads that take turns, and the synchronizer they queue on. Its protocol is the pattern: the leader promotes a follower before it starts processing, and a leader that processes first leaves the event sources unwatched for exactly as long as the work takes.

**HandleSet** — The collection of event sources the leader waits on, which returns when an operation on one of them can be started without blocking. What is in the set is what the pool can serve, and a source added to it without a handler is an event that wakes a thread and goes nowhere.

**EventHandler** — Declares the hook methods that process the events arriving on a source. It says nothing about which thread will call them, and that is the point: any thread in the pool may, so the implementation may hold no state belonging to one of them.
...
Serializes concurrent method calls on an object so that only one runs at a time, and lets its methods cooperatively schedule their turns.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| MonitorObject | `[MonitorObject.MonitorObject]` | interface, class | no | — |
| SynchronizedMethod | `[MonitorObject.SynchronizedMethod]` | method, property | no | — |
| MonitorLock | `[MonitorObject.MonitorLock]` | field, property | no | — |
| MonitorCondition | `[MonitorObject.MonitorCondition]` | field, property | yes | — |

**MonitorObject** — The object whose methods are serialized. It has no thread of its own: every method runs in the thread of the client that called it, which is the whole difference from an active object and the reason a long method here blocks a caller rather than a worker.

**SynchronizedMethod** — One of the thread-safe services the monitor exports. Exactly one of them runs inside the monitor at a time, whatever the number of threads calling and whatever the number of such methods — so the object's throughput is one method, not one per caller.

**MonitorLock** — The lock this monitor object holds of its own, taken as a synchronized method enters and released as it leaves. One monitor object, one lock: sharing a lock between two of them serializes both and neither of them says so.
...
Lets an event-driven application demultiplex and dispatch the completions of asynchronous operations, so concurrency is had without a thread per request.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Proactor | `[Proactor.Proactor]` | interface, class | no | — |
| AsynchronousOperation | `[Proactor.AsynchronousOperation]` | method | no | `Proactor` |
| AsynchronousOperationProcessor | `[Proactor.AsynchronousOperationProcessor]` | interface, class | yes | `Proactor` |
| CompletionHandler | `[Proactor.CompletionHandler]` | interface, class | no | `Proactor` |
| ProactiveInitiator | `[Proactor.ProactiveInitiator]` | interface, class | no | `Proactor` |

**Proactor** — Demultiplexes completion events and dispatches each to the handler that was registered with the operation. It is the reactor's counterpart moved to the other end: it waits for work to have finished rather than for work to be startable.

**AsynchronousOperation** — Started on the application's behalf and performed without borrowing the application's thread. Nothing after the call in that method has anything to do with the operation's outcome, which is the shape most easily misread as a sequence.

**AsynchronousOperationProcessor** — Carries out the operations and queues their completions. It is normally the operating system, and annotating the boundary is how a reader tells which asynchrony is the platform's and which the application built.

**CompletionHandler** — Declares the hooks the proactor calls when an operation finishes. What a handler is given is the completion, not the context that led to it, which is why this pattern arrives with the next one.
...
Lets an event-driven application demultiplex and dispatch service requests that arrive from one or more clients on a single thread.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Reactor | `[Reactor.Reactor]` | interface, class | no | — |
| SynchronousEventDemultiplexer | `[Reactor.SynchronousEventDemultiplexer]` | interface, class | yes | `Reactor` |
| Handle | `[Reactor.Handle]` | field, property | no | `Reactor` |
| EventHandler | `[Reactor.EventHandler]` | interface, class | no | `Reactor` |
| ConcreteEventHandler | `[Reactor.ConcreteEventHandler]` | class | no | `EventHandler` |

**Reactor** — Registers and removes event handlers and dispatches to them when their sources have events. It runs the loop that everything else waits inside, so anything slow reached from here delays every other source it is watching.

**SynchronousEventDemultiplexer** — Blocks until an operation can be started on one of the handles without blocking, and returns which. It is the only place the application is allowed to wait, and every other wait in a reactive design is a defect.

**Handle** — Identifies one source of events the reactor watches — a connection, a file, a timer. It is what the demultiplexer waits on, and a handle left registered after its source is finished is an event loop that wakes for nothing.

**EventHandler** — Declares the hook the reactor calls when a source has an event. It says nothing about a thread, because there is only one, which is the assumption everything implementing it inherits.
...
Ensures that a lock is acquired when control enters a scope and released automatically when control leaves it, by whatever path.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Guard | `[ScopedLocking.Guard]` | class, struct | no | — |
| Lock | `[ScopedLocking.Lock]` | field, property | no | — |

**Guard** — The class whose construction acquires the lock and whose disposal releases it. Every way out of the scope releases it — a return, a thrown exception, a branch added next year by somebody who never read this class — which is the one thing an explicit release on each path cannot promise.
...
Strategizes a component's synchronization by making its lock a pluggable type, so one implementation serves every concurrency use-case.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Component | `[StrategizedLocking.Component]` | class, struct | no | — |
| LockingStrategy | `[StrategizedLocking.LockingStrategy]` | interface, class, struct | yes | — |

**Component** — The component whose synchronization is configured into it rather than written into it. There is one implementation of the component and that is the point: a fix applied here reaches every configuration, where a family of near-identical classes drifts apart.
...
Ensures that intra-component method calls avoid self-deadlock and incur no unnecessary locking, by taking the lock only at the border of the component.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| Component | `[ThreadSafeInterface.Component]` | class, struct | no | — |
| InterfaceMethod | `[ThreadSafeInterface.InterfaceMethod]` | method, property | no | — |
| ImplementationMethod | `[ThreadSafeInterface.ImplementationMethod]` | method, property | no | — |

**Component** — The component whose lock is taken at its border and nowhere within. Its methods divide in two, and that division is the whole pattern: the annotation on the type says the division is meant, so a method that belongs to neither side is visible as an omission.

**InterfaceMethod** — A method callers reach from outside: it acquires the lock, forwards to an implementation method, and is responsible for releasing the lock when control returns to the caller. It performs the check, not the work.
...
Lets several threads use one logically global access point to fetch an object that is physically their own, without locking and without passing it through every call.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| ThreadSpecificObjectProxy | `[ThreadSpecificStorage.ThreadSpecificObjectProxy]` | interface, class | no | — |
| ThreadSpecificObject | `[ThreadSpecificStorage.ThreadSpecificObject]` | field, property | no | `ThreadSpecificObjectProxy` |
| ThreadSpecificObjectSet | `[ThreadSpecificStorage.ThreadSpecificObjectSet]` | interface, class | yes | `ThreadSpecificObjectProxy` |
| KeyFactory | `[ThreadSpecificStorage.KeyFactory]` | interface, class | yes | `ThreadSpecificObjectProxy` |

**ThreadSpecificObjectProxy** — The one access point every thread uses, which hides the key and the collection behind it and hands each caller its own object. It reads as global state and is not, which is the pattern's whole value and the reason a reader needs telling.

**ThreadSpecificObject** — One thread's own instance of the thread-specific object, reached only through the proxy. Nothing serializes access to it because nothing else can see it — so publishing a reference to it anywhere another thread can reach removes the only guarantee the pattern makes.

**ThreadSpecificObjectSet** — The per-thread set of that thread's objects, which the proxy uses and the caller never sees. On a platform whose runtime supplies thread-local storage this is the runtime's, and the role is for the codebases that keep their own.
...
Encapsulates the functions and data of an existing non-object-oriented API within concise, portable, cohesive class interfaces.

*Douglas Schmidt, Michael Stal, Hans Rohnert, Frank Buschmann, Pattern-Oriented Software Architecture, Volume 2, 2000.*

| Role | Annotation | Applies to | Repeatable | Links |
|---|---|---|---|---|
| WrapperFacade | `[WrapperFacade.WrapperFacade]` | class, struct | no | — |
| Functions | `[WrapperFacade.Functions]` | method | no | `WrapperFacade` |

**WrapperFacade** — The class that encapsulates the low-level functions and the data structures they work on, and forwards its callers' invocations to them. One place holds the platform's quirks, which is what a second platform makes visible.

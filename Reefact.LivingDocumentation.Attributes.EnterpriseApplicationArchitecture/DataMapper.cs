...
namespace Reefact.LivingDocumentation.Attributes.EnterpriseApplicationArchitecture {
    ...
    ///     </para>
    ///     <para>
    ///         A narrower case of Mapper: every participant annotated here is one of those too, and a consumer asking
    ...
    public sealed class DataMapperAttribute : MapperAttribute { }
